...
reasonably fast.  In Perl 5.8.1 and with this perl 
...
and this Perl the hash function is randomly perturbed by a
pseudorandom seed which makes generating such naughty hash keys
harder.  See L<perlrun/PERL_HASH_SEED> for more information.
